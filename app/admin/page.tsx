...
export default async function AdminLoginPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col px-4 pb-16 pt-6 sm:px-6 lg:px-8">
      <Link className="ui-link self-start" href="/">
        {dictionary.backToGallery}
      </Link>

      <section className="mx-auto mt-16 w-full max-w-sm border border-[var(--border-color)] bg-[var(--background-color)] p-6 sm:p-8">
        <h1 className="font-heading text-center text-3xl text-[var(--text-color)]">
